...
/****** Object:  Table [dbo].[s3ChangeLog]    Script Date: 18.07.2006 23:53:14 ******/
CREATE TABLE [dbo].[s3ChangeLog] (
...
ALTER TABLE [dbo].[s3ChangeLog] ADD
	CONSTRAINT [FK_s2ChangeLog_s2Tree] FOREIGN KEY
	(
		[evtCmdLuid]
	) REFERENCES [dbo].[s3Tree] (
		[lnkLuid]
...
alter table [dbo].[s3ChangeLog] nocheck constraint [FK_s2ChangeLog_s2Tree]
GO

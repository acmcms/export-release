// <%FORMAT: 'js' %>
window.DHTMLEd || (DHTMLEd = function(){
		//
	},
	DHTMLEd.PasteText = function() {
		var obj = this.parent.editorObject;
		DHTMLEd.pasteText(obj);
	},
	DHTMLEd.pasteText = function(obj) {
		var sText = HTMLEncode(clipboardData.getData("Text"));
		sText = sText.replace(/\n/g, '<BR>');
		insertHtml(sText, obj);
	},
	DHTMLEd.PasteWord = function() {
		var obj = this.parent.editorObject;
		DHTMLEd.pasteWord(obj);
	},
	DHTMLEd.pasteWord = function(obj) {
		insertHtml(DHTMLEd.cleanAndPaste(GetClipboardHTML()), obj);
	},
	DHTMLEd.cleanAndPaste = function(html) {
	...
	DHTMLEd.docCommand = function() {
		var obj = this.parent.editorObject;
		obj.DOM.execCommand(this.cm);
		obj.setFocus();
	},
	DHTMLEd.decCommand = function() {
		var obj = this.parent.editorObject;
		try {
	...
	(function(){
		for(var i in DHTMLEd.HTML){
			window[i] = DHTMLEd.HTML[i];
		}
	})(),
DHTMLEd) // <%/FORMAT%>
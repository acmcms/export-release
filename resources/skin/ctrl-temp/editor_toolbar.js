...
function CheckDecCommand(){
	return checkDecCommand(eval(this.cmEdit || this.cm), this.parent.editorObject);
}

function CheckDocCommand(){
	return checkDocCommand(this.cmEdit || this.cm, this.parent.editorObject);
}
...
function checkDocCommand(command,obj){
	...
	return (obj.DOM && obj.DOM.queryCommandValue(command)) ? 1 : 0;
}

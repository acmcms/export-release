...
function makeSequenceReply(context, layout){
	 ...
	 * .makeDataFormReply/.makeDataViewReply, not .makeSequenceReply - never exercised). Disabled
	 * the same way makeMessageReply's identical switch already was; falls through to the
	 * XML+XSL builder below for every format instead. */

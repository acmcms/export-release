 ...
 * domain-global.js
 * 
 * this script is executed in domain's GLOBAL context, implicitThisValue and
 * thisValue are both associated with domain's GLOBAL object.
 * 
 * EXAMPLE CODE:<code>
	 this.VlapanAPI = {
 ...
 * 1) %ACM_DOMAIN%/lib 
 * 2) %AE3_PROTECTED%/resources/lib/ 
 * 3) %AE3_PUBLIC%/resources/lib/
 * 
...
/**
 * virtual domain 'require's by prefix.
 */
const cachePkg = {};
 ...
 * 677 compliance.
 * 
 * Later you'll have to have this line in your server's global.js but now it is
 * still provided initially for everyone.
 */
require('ru.acmcms.internal/rt3/complianceGlobal').setupContext(this);


if(!server){
	throw new Error("'server' variable is expected to be defined in this context!");
}

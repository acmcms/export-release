...
exports.startAuth = function startAuth(startContext, returnLocation) {
	startContext.url = '/login.user?tp=lhigh&__auth_type=login_high&back=' + encodeURIComponent(returnLocation);
	return true;
};
...
exports.checkAuth = function checkAuth(checkContext, parameters) {
	...
	var passwordType = require('java.class/ru.myx.ae1.access.PasswordType').HIGHER,

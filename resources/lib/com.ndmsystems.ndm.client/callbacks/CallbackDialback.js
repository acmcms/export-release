...
CallbackDialback.prototype = Object.create(require("./AbstractCallback").prototype, {
	"CallbackDialback" : {
		value : CallbackDialback
	},
	"requestCallback" : {
	...
	"executeCallback" : {
		value : function(client){
			console.log(">>>>>> ndm.client:callback:dialback: connecting, %s", Format.jsObject(this));
	...
	"toString" : {
		value : function(){
			return "[CallbackDialback]";
		}
	}
});


Object.defineProperties(CallbackDialback, {
	"toString" : {
		value : function(){
			return "[CallbackDialbackClass]";
		}
	}
});

module.exports = CallbackDialback;